...
@interface ArticleViewControl ()<UITableViewDelegate, UIScrollViewDelegate>
...
- (void)viewDidLoad {
    ...
    UINavigationBarAppearance *articleAppearance = [[UINavigationBarAppearance alloc] init];
    articleAppearance.backgroundColor = [UIColor colorWithRed:79/225.0f green:141/225.0f blue:198/225.0f alpha:1];
    articleAppearance.titleTextAttributes = @{NSForegroundColorAttributeName:[UIColor whiteColor], NSFontAttributeName:[UIFont boldSystemFontOfSize:24]};
    self.navigationController.navigationBar.scrollEdgeAppearance = articleAppearance;
    self.navigationController.navigationBar.standardAppearance = articleAppearance;
